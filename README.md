...
> **v6.13.10** — module registry — bootstrap AWS Swarm + substrat AISIA
...
| `image_tag` | Tag d'image AISIA à déployer | `string` | `"v6.13.10"` | non |
...
| `image_tag` | `string` | `"v6.13.10"` | Tag d'image AISIA à déployer (ex. v6.13.10). |
