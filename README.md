...
> **v6.12.95** · code **v6.12.96** tagué, registry/images LIVE encore **v6.12.95** — module registry — bootstrap AWS Swarm + substrat AISIA
...
| SaaS opaque | Déployable Swarm/K8s — runtime **v6.12.95** · code **v6.12.96** |
...
| `image_tag` | Tag d'image AISIA à déployer | `string` | `"v6.12.96"` | non |
...
| `image_tag` | `string` | `"v6.12.96"` | Tag d'image AISIA à déployer (ex. v6.12.96). |
...
- **Version module / code** : **v6.12.96**
- **PROD LIVE documentaire** : **v6.12.95** (runtime cluster ; distinct du tag module)

<!-- TF-REGISTRY-STATUS -->
## Statut publication registry (honnête)

> Mesuré à la régénération docs · **version code TF** **v6.12.96** (`VERSION` modules + provider) · PROD LIVE documentaire **v6.12.95**.
