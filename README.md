...
> **v6.12.48** — module registry — bootstrap AWS Swarm + substrat AISIA
...
| SaaS opaque | Déployable Swarm/K8s — **v6.12.48** LIVE |
...
| `image_tag` | Tag d'image AISIA à déployer | `string` | `"v6.12.48"` | non |
