...
> **v6.12.73** — module registry — bootstrap AWS Swarm + substrat AISIA
...
| `image_tag` | Tag d'image AISIA à déployer | `string` | `"v6.12.73"` | non |
...
| `image_tag` | `string` | `"v6.12.73"` | Tag d'image AISIA à déployer (ex. v6.12.73). |
